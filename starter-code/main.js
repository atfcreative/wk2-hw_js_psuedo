...
var greeting2 = `Hello my ${name} is Anthony I'm ${age} and I live in ${address}`;
...
*/
	...
	MED---> 
	Make the list of 20 numbers
	Sort the numbers from largest to smallest
	The first number will be the answer
